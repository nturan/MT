      DOUBLE PRECISION FUNCTION SGU_TTBU(P1, P2, P3, P4, P5)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=GU_TTBU(P1, P2, P3, P4, P5,NHEL(1,IHEL)) 
             SGU_TTBU = SGU_TTBU + T
          ...
          ENDIF
      ENDDO
      SGU_TTBU = SGU_TTBU /  4D0 
      END
       
       
      DOUBLE PRECISION FUNCTION GU_TTBU(P1, P2, P3, P4, P5,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C ----------
      ...
      DO I = 1, NEIGEN
          ...
          ENDDO
          GU_TTBU =GU_TTBU+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
