      DOUBLE PRECISION FUNCTION SGG_TTB(P1, P2, P3, P4)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=GG_TTB(P1, P2, P3, P4,NHEL(1,IHEL)) 
             SGG_TTB = SGG_TTB + T
      ...
      DOUBLE PRECISION FUNCTION GG_TTB(P1, P2, P3, P4,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C COLOR DATA
C  
      DATA EIGEN_VAL(1  )/       7.291666666666666666666666666667D-02 /    
      DATA EIGEN_VEC(1  ,1  )/   7.071067811865475244008443621048D-01 /    
      DATA EIGEN_VEC(2  ,1  )/   7.071067811865475244008443621048D-01 /    
      DATA EIGEN_VEC(3  ,1  )/   0.000000000000000000000000000000D+00 /    
      DATA EIGEN_VAL(2  )/       2.812500000000000000000000000000D-01 /    
      DATA EIGEN_VEC(1  ,2  )/  -4.082482904638630163662140124510D-01 /    
      DATA EIGEN_VEC(2  ,2  )/   4.082482904638630163662140124510D-01 /    
      DATA EIGEN_VEC(3  ,2  )/   8.164965809277260327324280249020D-01 /    
C ----------
C BEGIN CODE
C ----------
