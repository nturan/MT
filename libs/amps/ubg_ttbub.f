      DOUBLE PRECISION FUNCTION SUBG_TTBUB(P1, P2, P3, P4, P5)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=UBG_TTBUB(P1, P2, P3, P4, P5,NHEL(1,IHEL)) 
             SUBG_TTBUB = SUBG_TTBUB + T
              IF (T .GT. 0D0 .AND. .NOT. GOODHEL(IHEL)) THEN
                  GOODHEL(IHEL)=.TRUE.
              ENDIF
          ENDIF
      ENDDO
      SUBG_TTBUB = SUBG_TTBUB /  4D0 
      END
       
       
      DOUBLE PRECISION FUNCTION UBG_TTBUB(P1, P2, P3, P4, P5,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C  
      ...
      DATA EIGEN_VEC(3  ,1  )/   0.000000000000000000000000000000D+00 /    
      DATA EIGEN_VEC(4  ,1  )/  -5.000000000000000000000000000000D-01 /    
      ...
      DATA EIGEN_VEC(3  ,2  )/   0.000000000000000000000000000000D+00 /    
      DATA EIGEN_VEC(4  ,2  )/  -5.000000000000000000000000000000D-01 /    
      ...
      DATA EIGEN_VEC(3  ,3  )/   7.071067811865475244008443621048D-01 /    
      DATA EIGEN_VEC(4  ,3  )/  -3.535533905932737622004221810524D-01 /    
      DATA EIGEN_VEC(5  ,3  )/   3.535533905932737622004221810524D-01 /    
C ----------
C BEGIN CODE
C ----------
      CALL OXXXXX(P1  ,FMASS(3  ),NHEL(1  ),-1,W1  )                       
      ...
      CALL IOVXXX(W5  ,W1  ,W7  ,GG,AMP(1  ))                              
      CALL FVIXXX(W4  ,W2  ,GG,FMASS(11 ),FWIDTH(11 ),W8  )                
      CALL JIOXXX(W5  ,W1  ,GG,ZERO,ZERO,W9  )                             
      CALL IOVXXX(W8  ,W3  ,W9  ,GG,AMP(2  ))                              
      CALL JIOXXX(W4  ,W3  ,GG,ZERO,ZERO,W10 )                             
      CALL GGGXXX(W9  ,W2  ,W10 ,G,AMP(3  ))                               
      CALL FVIXXX(W5  ,W2  ,GG,FMASS(3  ),FWIDTH(3  ),W11 )                
      CALL IOVXXX(W11 ,W1  ,W10 ,GG,AMP(4  ))                              
      CALL FVOXXX(W1  ,W2  ,GG,FMASS(3  ),FWIDTH(3  ),W12 )                
      ...
      DO I = 1, NEIGEN
          ...
          ENDDO
          UBG_TTBUB =UBG_TTBUB+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
