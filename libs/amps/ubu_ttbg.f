      DOUBLE PRECISION FUNCTION SUBU_TTBG(P1, P2, P3, P4, P5)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=UBU_TTBG(P1, P2, P3, P4, P5,NHEL(1,IHEL)) 
             SUBU_TTBG = SUBU_TTBG + T
              IF (T .GT. 0D0 .AND. .NOT. GOODHEL(IHEL)) THEN
                  GOODHEL(IHEL)=.TRUE.
              ENDIF
          ENDIF
      ENDDO
      SUBU_TTBG = SUBU_TTBG /  4D0 
      END
       
       
      DOUBLE PRECISION FUNCTION UBU_TTBG(P1, P2, P3, P4, P5,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C COLOR DATA
C  
      DATA EIGEN_VAL(1  )/       7.407407407407407407407407407407D-02 /    
      ...
      DATA EIGEN_VEC(5  ,1  )/   0.000000000000000000000000000000D+00 /    
      DATA EIGEN_VAL(2  )/       4.444444444444444444444444444444D-01 /    
      ...
      DATA EIGEN_VEC(5  ,2  )/   0.000000000000000000000000000000D+00 /    
      DATA EIGEN_VAL(3  )/       1.333333333333333333333333333333D+00 /    
      ...
      DATA EIGEN_VEC(5  ,3  )/  -7.071067811865475244008443621048D-01 /    
C ----------
C BEGIN CODE
C ----------
      ...
      CALL FVOXXX(W1  ,W5  ,GG,FMASS(3  ),FWIDTH(3  ),W7  )                
      CALL IOVXXX(W2  ,W7  ,W6  ,GG,AMP(1  ))                              
      CALL FVIXXX(W2  ,W5  ,GG,FMASS(3  ),FWIDTH(3  ),W8  )                
      CALL IOVXXX(W8  ,W1  ,W6  ,GG,AMP(2  ))                              
      CALL JIOXXX(W2  ,W1  ,GG,ZERO,ZERO,W9  )                             
      CALL FVIXXX(W4  ,W9  ,GG,FMASS(11 ),FWIDTH(11 ),W10 )                
      CALL IOVXXX(W10 ,W3  ,W5  ,GG,AMP(3  ))                              
      CALL FVOXXX(W3  ,W9  ,GG,FMASS(11 ),FWIDTH(11 ),W11 )                
      CALL IOVXXX(W4  ,W11 ,W5  ,GG,AMP(4  ))                              
      CALL GGGXXX(W5  ,W6  ,W9  ,G,AMP(5  ))                               
      UBU_TTBG = 0.D0 
      DO I = 1, NEIGEN
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NGRAPHS
          ...
          ENDDO
          UBU_TTBG =UBU_TTBG+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
