      DOUBLE PRECISION FUNCTION SUG_TTBU(P1, P2, P3, P4, P5)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=UG_TTBU(P1, P2, P3, P4, P5,NHEL(1,IHEL)) 
             SUG_TTBU = SUG_TTBU + T
          ...
          ENDIF
      ENDDO
      SUG_TTBU = SUG_TTBU /  4D0 
      END
       
       
      DOUBLE PRECISION FUNCTION UG_TTBU(P1, P2, P3, P4, P5,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C ----------
      ...
      CALL JIOXXX(W1  ,W5  ,GG,ZERO,ZERO,W9  )                             
      CALL IOVXXX(W8  ,W3  ,W9  ,GG,AMP(2  ))                              
      CALL JIOXXX(W4  ,W3  ,GG,ZERO,ZERO,W10 )                             
      CALL GGGXXX(W9  ,W2  ,W10 ,G,AMP(3  ))                               
      CALL FVOXXX(W5  ,W2  ,GG,FMASS(3  ),FWIDTH(3  ),W11 )                
      CALL IOVXXX(W1  ,W11 ,W10 ,GG,AMP(4  ))                              
      CALL FVIXXX(W1  ,W2  ,GG,FMASS(3  ),FWIDTH(3  ),W12 )                
      ...
      DO I = 1, NEIGEN
          ...
          ENDDO
          UG_TTBU =UG_TTBU+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
