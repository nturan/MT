      DOUBLE PRECISION FUNCTION SUBU_TTB(P1, P2, P3, P4)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=UBU_TTB(P1, P2, P3, P4,NHEL(1,IHEL)) 
             SUBU_TTB = SUBU_TTB + T
          ...
          ENDIF
      ENDDO
      SUBU_TTB = SUBU_TTB /  4D0 
      END
       
       
      DOUBLE PRECISION FUNCTION UBU_TTB(P1, P2, P3, P4,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C ----------
      ...
      CALL JIOXXX(W2  ,W1  ,GG,ZERO,ZERO,W5  )                             
      ...
      DO I = 1, NEIGEN
          ...
          ENDDO
          UBU_TTB =UBU_TTB+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
