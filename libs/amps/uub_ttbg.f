      DOUBLE PRECISION FUNCTION SUUB_TTBG(P1, P2, P3, P4, P5)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=UUB_TTBG(P1, P2, P3, P4, P5,NHEL(1,IHEL)) 
             SUUB_TTBG = SUUB_TTBG + T
              IF (T .GT. 0D0 .AND. .NOT. GOODHEL(IHEL)) THEN
                  GOODHEL(IHEL)=.TRUE.
              ENDIF
          ENDIF
      ENDDO
      SUUB_TTBG = SUUB_TTBG /  4D0 
      END
       
       
      DOUBLE PRECISION FUNCTION UUB_TTBG(P1, P2, P3, P4, P5,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C ----------
      ...
      CALL FVIXXX(W1  ,W5  ,GG,FMASS(3  ),FWIDTH(3  ),W7  )                
      CALL IOVXXX(W7  ,W2  ,W6  ,GG,AMP(1  ))                              
      CALL FVOXXX(W2  ,W5  ,GG,FMASS(3  ),FWIDTH(3  ),W8  )                
      ...
      DO I = 1, NEIGEN
          ...
          ENDDO
          UUB_TTBG =UUB_TTBG+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
