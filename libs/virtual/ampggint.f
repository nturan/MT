...
!     initialize basis scalar one-loop integrals
      ...
      scin(9)=2-scin(1)+qlI2(s14,m2,m2,musq,0)
      scin(10)=qlI3(zip,zip,s14,m2,m2,m2,musq,0)
      scin(11)=qlI3(s12,zip,m2,zip,m2,m2,musq,0)
      scin(12)=qlI3(s14,m2,m2,m2,m2,zip,musq,0)
      scin(13)=qlI4(m2,zip,zip,m2,s12,s14,zip,m2,m2,m2,musq,0)
      scin(14)=qlI2(s13,zip,m2,musq,0)
      scin(15)=-scin(1)+scin(14)
      scin(16)=qlI3(s13,zip,m2,m2,zip,zip,musq,0)
      scin(17)=qlI3(s13,zip,m2,zip,m2,m2,musq,0)
      scin(18)=qlI4(m2,zip,m2,zip,s12,s13,zip,m2,m2,zip,musq,0)
      scin(19)=qlI4(zip,m2,m2,zip,s13,s14,zip,zip,m2,zip,musq,0)
      scin(20)=qlI4(m2,zip,zip,m2,s13,s14,zip,m2,m2,m2,musq,0)
      scin(21)=qlI4(m2,zip,m2,zip,s13,s12,zip,m2,m2,zip,musq,0)
