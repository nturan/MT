...
!     Turan modified the functions bsyggttsq and bsyqqttsq
!     to not return born values.
      subroutine bsyggttsq(pp1,pp2,pp3,pp4,mur2,sqamp)
      implicit none
      include 'bsyparams.h'
...
! it is not a problem.
     ...
     # +9D0*(PggL23*sqA0a + PggL32*sqA0b + PggSL*sqA0sl))/3D0
      ...
      subroutine bsyqqttsq(pp1,pp2,pp3,pp4,mur2,sqamp)
      implicit none
      include 'bsyparams.h'
      double precision pp1(4),pp2(4),pp3(4),pp4(4),mur2
      double precision p1(4),p2(4),p3(4),p4(4)
